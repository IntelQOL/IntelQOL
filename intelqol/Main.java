...
import intelqol.commands.*;
import intelqol.features.BlockBreakAura;
import intelqol.features.*;
import intelqol.utils.OpenSkyblockGui;
...
public class Main {
    ...
    public void onFMLInitialization(FMLPreInitializationEvent event) {
        File directory = new File(event.getModConfigurationDirectory(), "intelqol");
        if (!directory.exists()) {
            directory.mkdirs();
        }
    }
    ...
    public void init(FMLInitializationEvent event) {
        ...
        ClientCommandHandler.instance.registerCommand(new Wardrobe());
